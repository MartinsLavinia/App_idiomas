...
CREATE TABLE `blocos_atividades` (
  ...
  `total_atividades` int(11) DEFAULT 12,
  `atividades_gramatica` int(11) DEFAULT 6,
  `atividades_fala` int(11) DEFAULT 3,
  `atividades_dificeis` int(11) DEFAULT 3,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-11-27 12:50:32
