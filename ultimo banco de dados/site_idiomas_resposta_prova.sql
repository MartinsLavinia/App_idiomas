...
CREATE TABLE `resposta_prova` (
  ...
  `id_resultado_prova` int(11) NOT NULL,
  `id_questao` int(11) NOT NULL,
  `resposta_usuario` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`resposta_usuario`)),
...
-- Dump completed on 2025-11-27 12:50:30
