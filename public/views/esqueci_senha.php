...
// Removido require_once "config_esquecisenhau.php" pois não existe no código
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($stmt_token->execute()) {
            ...
            $assunto = "Redefinição de Senha - Site de Idiomas";
            $mensagem = "
            Olá {$usuario['nome']},
            ...
            if (mail($email, $assunto, $mensagem, $headers)) {
                $sucesso = "Um link para redefinir sua senha foi enviado para seu e-mail!";
            } else {
                $erro = "Erro ao enviar email. Por favor, tente novamente.";
            }
        } else {
...
<head>
    ...
    <title>Recuperar Senha - Site de Idiomas</title>
...
<body>
    ...
    <div class="form-container">
        ...
        <div class="info-text">
            ...
            Um link de redefinição será enviado para seu e-mail. O link expira em 1 hora.
        </div>
